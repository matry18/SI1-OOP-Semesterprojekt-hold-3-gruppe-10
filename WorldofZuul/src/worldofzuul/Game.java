...
public class Game {
    ...
    private void createRooms() {
        ...
        r2C.setCurse(new Curse("BAM WAM SLAM!", "You get hit and you do not know by what.", "You now have a cursed armor.", "/Pictures/Curses/BAMWAMSLAM!.png"));
        ...
        r8C.setCurse(new Curse("Fancy hat with feathers.", "The hat i fancy, because it got feathers!", "You now have a cursed headgear.", "/Pictures/Curses/Fancyhatwithfeathers.png"));
        ...
        r14C.setCurse(new Curse("Harsh Language!", "A rat says something very unpleasant about your mother.", "You now have a cursed haedgear.", "/Pictures/Curses/HarshLanguage!.png"));
        r18C.setCurse(new Curse("Shitter Twitter Trump!?", "He hacks your Twitter account and posts shit.", "You now have a cursed weapon.", "/Pictures/Curses/ShitterTwitterTrump!.png"));
        r21C.setCurse(new Curse("Tiny Hands!", "Tiny hands comes flying toward you, they taking your weapon!", "You now have a cursed weapon.", "/Pictures/Curses/TinyHands!.png"));
        r24C.setCurse(new Curse("Rolling Stone!", "A huge round stone rolls towards you, INDIANA JONES STYLE!", "You now have a cursed weapon.", "/Pictures/Curses/RollingStone!.png"));
        r25C.setCurse(new Curse("Duck of Doom!", "A menacing presence makes you shiver.", "You now have a cursed armor.", "/Pictures/Curses/DuckofDoom!.png"));
        r30C.setCurse(new Curse("Josef F. Ritzl?!", "He invites you in to his cellar and locks you up.", "You now have a cursed weapon.", "/Pictures/Curses/JosefFRitzl.png"));
        r40C.setCurse(new Curse("Tar room.", "You jump into the room, only to find your feet getting stuck in the tar.", "You now have a cursed footgear.", "/Pictures/Curses/Tarroom.png"));
        ...
        r3M.setMonster(new Monster("The Bully", "He bullys you into submission(you notice a trap door behind him).", 4, "Lose 1 level.", -1, "/Pictures/Monster/TheBully.png"));
        ...
        r6M.setMonster(new Monster("The Karate Squid", "Makes sushi out of you. He will chop you up in small pieces!", 8, "His arm attacks you from behind. Lose 2 levels.", -2, "/Pictures/Monster/TheKarateSquid.png"));
        ...
        r11M.setMonster(new Monster("The Stoned Golem", "He's sooo stooned broo.", 7, "He falls over and lands on you left foot. Lose 1 level.", -1, "/Pictures/Monster/TheStonedGolem.png"));
        ...
        r26M.setMonster(new Monster("Trubadourix", "He will sing you a song... which sounds awful!", 14, "Your eardrums inflate so much that your headgear cease to be able to fit your head! Lose 3 levels.", -3, "/Pictures/Monster/trubadourix.png"));
        ...
        r33M.setMonster(new Monster("The Doom Donuts", "They have an affinity for everything with a 0 in it.", 7, "Lose 0 levels.", 0, "/Pictures/Monster/TheDoomDonuts.png"));
        r34M.setMonster(new Monster("Topless Dancer", "He/she shakes em'.", 9, "Lose 2 levels.", -2, "/Pictures/Monster/Topless_Dancer.png"));
        r35M.setMonster(new Monster("The Great Cornholio", "Hehehehh… Heheheheh.", 8, "You lose a level… or something.", -1, "/Pictures/Monster/the_great_cornholio.png"));
